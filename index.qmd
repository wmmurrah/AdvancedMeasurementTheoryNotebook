...
The class will be using the textbook *Handbook of Educational Measurement and Psychometrics Using R* [@Desjardins2018Handbookeducationalmeasurement], which will be the primary source for learning to use R for the methods covered in this course.
=======
# Introduction to the Course

Welcome!
This is a notebook for ERMA 8350 Advanced Measurement Theory.
The class will be using the textbook *Handbook of Educational Measurement and Psychometrics Using R* [@desjardins2018handbook], which will be the primary source for learning to use R for the methods covered in this course.
>>>>>>> Quartobook:index.qmd
...
So, learning how to **install** packages (downloading from the web to your computer) and **loading** packages (making the package's functions accessible to your current R session) are important skills to master.
